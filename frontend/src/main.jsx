...
const avatarEmoji=a=>({knight:'ðŸ›¡ï¸',mage:'ðŸ§™',rogue:'ðŸ—¡ï¸',healer:'ðŸ§',hero:'âš”ï¸'})[a]||'âš”ï¸';
function App(){
   ...
   if(code&&state&&auth){
     const handleOAuthCallback=async()=>{
       ...
       try{
         ...
         setToast(`ðŸŽ‰ ${provider} successfully connected!`);
         await load();
         setPage('integrations');
       }catch(err){
 ...
 if(!dash||!me)return <div className="boot"><Gamepad2/><b>Loading your worldâ€¦</b><span>Syncing your campaign</span></div>;
...
function WorldEntry(){
 return <div className="worldEntry" aria-label="Entering LIFE RPG">
  ...
  <div className="worldEntryStars"><span>âœ¦</span><span>Â·</span><span>âœ§</span><span>Â·</span><span>âœ¦</span></div>
  <div className="worldEntryAvatar">
   <div className="entryAvatarCircle">âš”ï¸</div>
 ...
 return <div className="landingPage cinematicLanding">
  ...
  <main>
   <section className="landingHero" id="experience">
    ...
    <div className="heroStage" data-reveal><div className="heroOrbit orbitOne"/><div className="heroOrbit orbitTwo"/><div className="heroGlow"/><div className="heroLevel"><span>01</span> LEVEL UP YOUR LIFE</div><div className="characterArt" onClick={onEnter} role="button" tabIndex={0} onKeyDown={e=>{if(e.key==='Enter'||e.key===' ')onEnter()}} aria-label="Enter the world"><div className="characterScan"/><div className="characterHead">âš”</div><div className="characterBody"><span>XP</span><b>âˆž</b><span>QUEST</span></div><div className="characterCore"/><div className="avatarInteractHint">CLICK TO ENTER</div></div><div className="floatingCard cardOne"><span>QUEST COMPLETE</span><b>+120 XP</b><small>REAL WORLD ACTION</small></div><div className="floatingCard cardTwo"><span>SKILL UNLOCKED</span><b>Focus +1</b><small>LEVEL 07 â†’ 08</small></div><div className="floatingCard cardThree"><span>AI GAME MASTER</span><b>Next move ready</b><small>ADAPTIVE CAMPAIGN</small></div></div>
   ...
   <section className="storySection" id="features">
    <div className="storyIntro" data-reveal><div><span className="sectionEyebrow">âœ¦ THE GAME LOOP</span><h2>Your life,<br/><em>but playable.</em></h2></div><p>LIFE RPG turns goals, habits and ambitions into an adaptive campaign with visible progress, meaningful quests and an AI Game Master that keeps your next move clear.</p></div>
    <div className="featureRail">
     <div data-reveal><FeaturePanel tag="01 Â· SETUP" title="Build your character" text="Tell the Game Master what matters. Your goals become the foundation of your personal campaign." visual="character"/></div>
     <div data-reveal><FeaturePanel tag="02 Â· IDENTITY" title="Watch yourself evolve" text="Levels, XP, skills and attributes change as you take real-world action." visual="stats"/></div>
     <div data-reveal><FeaturePanel tag="03 Â· QUESTS" title="Make progress playable" text="Small actions become daily missions. Complete them, submit evidence and keep your campaign moving." visual="quests"/></div>
     <div data-reveal><FeaturePanel tag="04 Â· BOSS BATTLE" title="Face the hard days" text="Turn procrastination, distraction and difficult milestones into encounters you can overcome." visual="boss"/></div>
    </div>
   </section>

   <section className="whatSection" id="how"><div className="sectionCenter" data-reveal><span className="sectionEyebrow">âœ¦ WHAT IS LIFE RPG?</span><h2>Real life.<br/><em>RPG rules.</em></h2><p>One system connecting ambition, action, evidence, learning and progression.</p></div><div className="loopGrid" data-reveal><LoopStep n="01" title="Choose a goal" icon={<Target/>}/><LoopStep n="02" title="AI builds your campaign" icon={<Sparkles/>}/><LoopStep n="03" title="Complete real quests" icon={<Swords/>}/><LoopStep n="04" title="Earn XP & level up" icon={<Zap/>}/></div></section>

   <section className="dashboardReveal"><div className="dashboardIntro" data-reveal><span className="sectionEyebrow">âœ¦ YOUR WORLD</span><h2>A command center<br/>for your <em>real life.</em></h2><p>Goals, quests, skills, bosses and progress â€” designed as one living campaign.</p></div><div className="mockDashboard" data-reveal><div className="mockTop"><b>â˜· LIFE RPG</b><span>CAMPAIGN // ACTIVE</span><i>LVL 07</i></div><div className="mockBody"><aside><b>YOUR HERO</b><div className="mockAvatar">âš”ï¸</div><strong>THE ADVENTURER</strong><small>2,450 XP</small><div className="mockBar"><i/></div><span>FOCUS Â· 72</span><span>DISCIPLINE Â· 64</span><span>CREATIVITY Â· 81</span></aside><div className="mockMain"><div className="mockHeading"><div><small>ACTIVE CAMPAIGN</small><h3>Become a stronger developer</h3></div><button onClick={onEnter}>OPEN WORLD <ArrowRight/></button></div><div className="mockCards"><MockQuest title="Ship one project" xp="+150 XP"/><MockQuest title="Practice system design" xp="+90 XP"/><MockQuest title="Read 20 pages" xp="+60 XP"/></div><div className="mockBoss"><div><small>NEXT BOSS</small><h3>PROCRASTINATION</h3></div><div className="hp"><span/><span/><span/><span/><span/></div><b>42% HP</b></div></div></div></div></section>

   <section className="pricingSection" id="pricing"><div className="sectionCenter" data-reveal><span className="sectionEyebrow">âœ¦ START YOUR CAMPAIGN</span><h2>Stop planning.<br/><em>Start playing.</em></h2><p>Enter the world and turn one meaningful goal into your first campaign.</p></div><div className="priceGrid" data-reveal><PriceCard label="PREVIEW" title="Free" text="Start building your character and experience the core loop." features={["Character creation","Daily quests","Basic XP progression"]} onClick={onEnter}/><PriceCard label="HERO" title="LIFE RPG" text="Unlock the full campaign experience." features={["Adaptive AI campaigns","Skills & boss battles","Analytics & weekly review","Evidence-based progression"]} featured onClick={onEnter}/><PriceCard label="FUTURE" title="Guild" text="Shared progression for future community play." features={["Community features","Shared challenges","Future integrations"]} onClick={onEnter}/></div></section>
  </main>
...
function FeaturePanel({tag,title,text,visual}){return <article className="featurePanel"><div className="featureCopy"><span className="pill">âœ¦ {tag}</span><h3>{title}</h3><p>{text}</p></div><div className={'featureVisual '+visual}>{visual==='character'&&<><div className="paperAvatar">âš”ï¸</div><b>STEP 02</b><span>SETUP YOUR CHARACTER IDENTITY</span><div className="paperLine"></div><div className="paperLine short"></div></>}{visual==='stats'&&<><div className="statAvatar">ðŸ›¡ï¸</div><div className="radar">â—ˆ</div><b>LEVEL 07 Â· 2,450 XP</b><small>FOCUS 72 Â· DISCIPLINE 64 Â· CREATIVITY 81</small></>}{visual==='quests'&&<><div className="questWindow"><b>TODAY</b><span>â˜‘ Ship project</span><span>â˜‘ 30 min deep work</span><span>â˜ Read 20 pages</span><strong>+150 XP</strong></div></>}{visual==='boss'&&<><div className="bossVisual"><Crown/><b>PROCRASTINATION</b><div><i/><i/><i/><i/></div><small>42% HP REMAINING</small></div></>}</div></article>}
 ...
 return <div className="page rpgDashboard">
  ...
  <div className="rpgHomeGrid">
   <section className="panel rpgQuestPanel">
    ...
    <div className="rpgQuestList">{quests.length?quests.map((quest,i)=><button className="rpgQuestRow" key={quest.id||i} onClick={()=>setPage('quests')}><span className="rpgQuestIcon">{i===0?<Swords/>:i===1?<BookOpen/>:<Dumbbell/>}</span><span className="grow"><b>{quest.title}</b><small>{quest.description||`${quest.estimated_minutes||30} min Â· Build your consistency`}</small></span><strong>+{quest.reward||quest.reward_xp||25} XP</strong><ChevronRight/></button>):<button className="rpgQuestRow" onClick={()=>setPage('goals')}><span className="rpgQuestIcon"><Swords/></span><span className="grow"><b>Create your first campaign</b><small>Set your long-term goal</small></span><strong>+50 XP</strong><ChevronRight/></button>}</div>
   </section>

   <section className="rpgJourney panel"><div className="rpgJourneyOverlay"/><div className="panelHead"><h2><Flag/> YOUR JOURNEY</h2><button onClick={()=>setPage('campaign')}>Open <ArrowRight/></button></div><div className="journeyPath"><div className="journeyNode current"><span>âš‘</span><b>Lv {dash.user.level}</b><small>You are here</small></div><div className="journeyNode"><span>âš”</span><b>Lv 5</b><small>The Disciplined</small></div><div className="journeyNode"><span>âœ¦</span><b>Lv 10</b><small>The Focused</small></div><div className="journeyNode"><span>â™›</span><b>Lv 20</b><small>The Unstoppable</small></div></div><div className="journeyCaption">SAME YOU. <b>HIGHER LEVEL.</b></div></section>

   <section className="panel rpgFocusPanel"><div className="panelHead"><h2><Sparkles/> DAILY FOCUS</h2><button onClick={()=>setPage('analytics')}>Edit</button></div>{focus.map(({name,icon:Icon})=>{const c=dash.categories.find(x=>x.name.toLowerCase()===name.toLowerCase());const value=c?.progress||0;return <div className="rpgFocusRow" key={name}><Icon/><span>{name}</span><div><i style={{width:`${value}%`}}/></div><b>{value}%</b></div>})}<div className="rpgQuote"><span>âœ¦</span><em>â€œProgress, not perfection.â€</em></div></section>
  </div>
  ...
  const syncProvider=async p=>{
    ...
    try{
      ...
      if(awarded > 0){
        ...
        alert(`ðŸŽ‰ ${p.provider} Sync Complete!\n\n+${awarded} XP Awarded!\nQuests Cleared: ${quests}`);
      }
    }catch(e){
        ...
        return <div className="intCard panel" key={x.provider}>
          <div className="intTop">
              ...
              <div className="intTitle">
                ...
                <div>
                  <span className={`intStatusPill ${isConn?'live':'disconnected'}`}>
                    {isConn?'â— LIVE CONNECTED':'â—‹ NOT CONNECTED'}
                  </span>
                </div>
                <div>
                  <span className={`configBadge ${isConfigured?'ready':'unconfigured'}`}>
                    {isConfigured?'âš¡ Live OAuth Ready':'âš ï¸ Not Configured'}
                  </span>
                </div>
            ...
            {isConn&&<button className="syncBtn" disabled={syncing[x.provider]} onClick={()=>syncProvider(x)}>
              <RefreshCw className={syncing[x.provider]?'spin':''} size={12}/> {syncing[x.provider]?'Syncingâ€¦':'Sync Now'}
            </button>}
          </div>
          ...
          {isConn&&<div className="intMeta">
            ...
            {meta.summary&&<div style={{marginTop:4,color:'var(--accent)'}}>â„¹ï¸ {meta.summary}</div>}
            {x.error_message&&<div style={{marginTop:4,color:'var(--danger)'}}>âš ï¸ {x.error_message}</div>}
      ...
      <div className="activityFeedGrid">
        {activities.slice(0,6).map((act,idx)=><div className="feedCard" key={idx}>
          <div className="feedCardTop">
            <b>{act.provider} Â· {act.activity_type.replace('_',' ').toUpperCase()}</b>
...
function Loading(){return <div className="loadingPage"><Gamepad2/><b>Loadingâ€¦</b></div>}
